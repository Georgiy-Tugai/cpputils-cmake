* cpputils-cmake.el (version 0.4.10)
...
* Tips
** Use "relative/path" instead of "./relative/path" in CMakeLists.txt
Cmake will convert all the relative path to full path by appending parent directory.

"./relative/path" will be converted to "/home/username/myproj/./relative/path". cpputils-cmake will still work in this case, but Emacs itself has some issue to search C/C++ header file under those containing-dot-character path.
